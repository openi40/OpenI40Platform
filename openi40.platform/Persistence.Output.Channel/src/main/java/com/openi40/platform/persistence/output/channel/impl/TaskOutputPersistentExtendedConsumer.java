...
public class TaskOutputPersistentExtendedConsumer extends AbstractPersistentExtendedConsumer<TaskOutputDto> {
	...
	public static class TaskOutputPersistentExtendedConsumerFactory
		...
		public TaskOutputPersistentExtendedConsumerFactory(ObjectMapper mapper) {
			super(mapper, TaskOutputDto.class);

		}

		@Override
		public AbstractPersistentExtendedConsumer<TaskOutputDto> create(JDBCOutputTransactionWrapper wrapper) {

			return new TaskOutputPersistentExtendedConsumer(mapper, wrapper);
		}

	};

	public TaskOutputPersistentExtendedConsumer(ObjectMapper mapper, JDBCOutputTransactionWrapper wrapper) {
		super(TaskOutputDto.class, mapper, wrapper);
	...
	@Override
	protected void save(List<TaskOutputDto> list) throws SQLException {
		...
		String vectorialDeletes[] = { deleteSecondary, deleteWhousePick, deleteTaskPick, deletePurchasePick, deleteTRC,
				deleteTRP, deleteAcqSetupRC, deleteAcqWorkRC, deleteAPSMSG };
