...
public class TaskRelationOutputPersistentExtendedConsumer
	...
	public static class TaskRelationOutputPersistentExtendedConsumerFactory
		...
		public TaskRelationOutputPersistentExtendedConsumerFactory(ObjectMapper mapper) {
			super(mapper, TaskRelationOutputDto.class);

		}

		@Override
		public AbstractPersistentExtendedConsumer<TaskRelationOutputDto> create(JDBCOutputTransactionWrapper wrapper) {

			return new TaskRelationOutputPersistentExtendedConsumer(mapper, wrapper);
		}

	}

	public TaskRelationOutputPersistentExtendedConsumer(ObjectMapper mapper, JDBCOutputTransactionWrapper wrapper) {
		super(TaskRelationOutputDto.class, mapper, wrapper);
	...
	@Override
	protected void save(List<TaskRelationOutputDto> list) throws SQLException {
