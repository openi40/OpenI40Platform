...
@AttributeOverrides(value = { @AttributeOverride(name = "code", column = @Column(name = "code")),
		...
		@AttributeOverride(name = "supplyTaskCode", column = @Column(name = "supply_task")),
		@AttributeOverride(name = "supplyWorkOrderCode", column = @Column(name = "supply_work_order")) })
public class TaskProductionMaterialReservation extends TaskProductionMaterialReservationInputDto {

	public TaskProductionMaterialReservation() {
