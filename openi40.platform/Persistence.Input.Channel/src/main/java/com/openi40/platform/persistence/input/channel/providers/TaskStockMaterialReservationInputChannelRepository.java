...
@Repository
public interface TaskStockMaterialReservationInputChannelRepository extends InputChannelRepository<TaskStockMaterialReservation, TaskStockMaterialReservationInputDto> {
