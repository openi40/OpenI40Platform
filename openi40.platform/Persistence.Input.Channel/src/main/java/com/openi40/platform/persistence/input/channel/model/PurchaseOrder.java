...
public class PurchaseOrder extends PurchaseOrderInputDto {
	@Id
	@Override
	...
	@StreamLoadRelated(overriddenType = com.openi40.scheduler.input.model.orders.PurchaseOrderLineInputDto.class, loadType = PurchaseOrderLine.class, relationType = RelationType.ONE2MANY, joinProperty = "orderCode")
	@Override
	public void setOrderLines(java.util.List<com.openi40.scheduler.input.model.orders.PurchaseOrderLineInputDto> p) {
