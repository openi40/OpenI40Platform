...
@AttributeOverrides(value = { @AttributeOverride(name = "code", column = @Column(name = "code")),
		...
		@AttributeOverride(name = "purchaseOrderCode", column = @Column(name = "purch_order")),
		@AttributeOverride(name = "purchaseOrderLineCode", column = @Column(name = "purch_order_line")) })
public class TaskPurchaseMaterialReservation extends TaskPurchaseMaterialReservationInputDto {
	
	public TaskPurchaseMaterialReservation() {
