...
public class OperationEquipmentSpecification extends OperationEquipmentSpecificationInputDto {
	...
	@StreamLoadRelated(overriddenType = com.openi40.scheduler.input.model.cycles.MachinePriorityInputDto.class, loadType = MachinePriority.class, relationType = RelationType.ONE2MANY, joinProperty = "operationEquipmentSpecCode")
	@Override
	public void setMachinePriorities(
			java.util.List<com.openi40.scheduler.input.model.cycles.MachinePriorityInputDto> p) {
		super.setMachinePriorities(p);
	}

	@StreamLoadRelated(overriddenType = com.openi40.scheduler.input.model.cycles.SecondaryResourceUseSpecificationInputDto.class, loadType = SecondaryResourceUseSpecification.class, relationType = RelationType.ONE2MANY, joinProperty = "operationEquipmentSpecCode")
	@Override
	public void setSecondaryResourcesSpecs(
			java.util.List<com.openi40.scheduler.input.model.cycles.SecondaryResourceUseSpecificationInputDto> p) {
