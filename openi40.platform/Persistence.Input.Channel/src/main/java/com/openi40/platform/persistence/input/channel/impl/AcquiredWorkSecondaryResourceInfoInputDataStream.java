...
import com.openi40.platform.persistence.input.channel.model.AcquiredWorkSecondaryResourceInfo;
...
import com.openi40.platform.persistence.input.channel.providers.AcquiredWorkSecondaryResourceInfoRepository;
...
@Service
public class AcquiredWorkSecondaryResourceInfoInputDataStream extends
		AbstractPersistenceInputDataStream<AcquiredWorkSecondaryResourceInfo, UsedSecondaryResourcesInfoInputDto, AcquiredWorkSecondaryResourceInfoRepository> {

	public AcquiredWorkSecondaryResourceInfoInputDataStream(AcquiredWorkSecondaryResourceInfoRepository repository) {
		super(AcquiredWorkSecondaryResourceInfo.class, UsedSecondaryResourcesInfoInputDto.class, repository);
