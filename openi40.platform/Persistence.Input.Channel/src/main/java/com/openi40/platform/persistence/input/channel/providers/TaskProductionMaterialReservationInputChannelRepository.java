...
@Repository
public interface TaskProductionMaterialReservationInputChannelRepository
		extends InputChannelRepository<TaskProductionMaterialReservation, TaskProductionMaterialReservationInputDto> {
