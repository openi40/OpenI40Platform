...
public class CycleModel extends CycleModelInputDto {
	...
	@StreamLoadRelated(overriddenType = com.openi40.scheduler.input.model.cycles.OperationModelInputDto.class, loadType = OperationModel.class, relationType = RelationType.ONE2MANY, joinProperty = "cycleCode", orderOptions = "sequenceCode")
	@Override
