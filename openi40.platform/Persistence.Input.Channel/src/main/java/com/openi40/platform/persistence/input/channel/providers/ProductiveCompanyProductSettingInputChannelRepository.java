...
@Repository
public interface ProductiveCompanyProductSettingInputChannelRepository
		extends InputChannelRepository<ProductiveCompanyProductSetting, ProductiveCompanyProductSettingInputDto> {
