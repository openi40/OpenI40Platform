...
export class Oi40DbTaskStockMaterialReservationRepositoryService {
     ...
     * @param reportProgress flag to report request and response progress.
     */
    public findAllPage33(p: Pageable, observe?: 'body', reportProgress?: boolean): Observable<PageOI40DBTaskStockMaterialReservation>;
    public findAllPage33(p: Pageable, observe?: 'response', reportProgress?: boolean): Observable<HttpResponse<PageOI40DBTaskStockMaterialReservation>>;
    public findAllPage33(p: Pageable, observe?: 'events', reportProgress?: boolean): Observable<HttpEvent<PageOI40DBTaskStockMaterialReservation>>;
    public findAllPage33(p: Pageable, observe: any = 'body', reportProgress: boolean = false ): Observable<any> {

        if (p === null || p === undefined) {
            throw new Error('Required parameter p was null or undefined when calling findAllPage33.');
        }
     ...
     * @param reportProgress flag to report request and response progress.
     */
    public findByQbePagedPage33(qbe: OI40DBTaskStockMaterialReservation, offset?: number, pageNumber?: number, pageSize?: number, paged?: boolean, sortSorted?: boolean, sortUnsorted?: boolean, unpaged?: boolean, observe?: 'body', reportProgress?: boolean): Observable<PageOI40DBTaskStockMaterialReservation>;
    public findByQbePagedPage33(qbe: OI40DBTaskStockMaterialReservation, offset?: number, pageNumber?: number, pageSize?: number, paged?: boolean, sortSorted?: boolean, sortUnsorted?: boolean, unpaged?: boolean, observe?: 'response', reportProgress?: boolean): Observable<HttpResponse<PageOI40DBTaskStockMaterialReservation>>;
    public findByQbePagedPage33(qbe: OI40DBTaskStockMaterialReservation, offset?: number, pageNumber?: number, pageSize?: number, paged?: boolean, sortSorted?: boolean, sortUnsorted?: boolean, unpaged?: boolean, observe?: 'events', reportProgress?: boolean): Observable<HttpEvent<PageOI40DBTaskStockMaterialReservation>>;
    public findByQbePagedPage33(qbe: OI40DBTaskStockMaterialReservation, offset?: number, pageNumber?: number, pageSize?: number, paged?: boolean, sortSorted?: boolean, sortUnsorted?: boolean, unpaged?: boolean, observe: any = 'body', reportProgress: boolean = false ): Observable<any> {

        if (qbe === null || qbe === undefined) {
            throw new Error('Required parameter qbe was null or undefined when calling findByQbePagedPage33.');
        }
