...
export class Oi40DbPartnerRepositoryService {
    ...
    public deleteByCodeVoid12(code: string, observe: any = 'body', reportProgress: boolean = false ): Observable<any> {
        ...
        return this.httpClient.get<any>(`${this.basePath}/integration/OI40DBPartner/deleteByCode`,
            {
     ...
     * @param reportProgress flag to report request and response progress.
     */
    public doAutocompletePageOI40DBPartner(autoCompleteData: AutoCompleteData, observe?: 'body', reportProgress?: boolean): Observable<PageOI40DBPartner>;
    public doAutocompletePageOI40DBPartner(autoCompleteData: AutoCompleteData, observe?: 'response', reportProgress?: boolean): Observable<HttpResponse<PageOI40DBPartner>>;
    public doAutocompletePageOI40DBPartner(autoCompleteData: AutoCompleteData, observe?: 'events', reportProgress?: boolean): Observable<HttpEvent<PageOI40DBPartner>>;
    public doAutocompletePageOI40DBPartner(autoCompleteData: AutoCompleteData, observe: any = 'body', reportProgress: boolean = false ): Observable<any> {

        if (autoCompleteData === null || autoCompleteData === undefined) {
            throw new Error('Required parameter autoCompleteData was null or undefined when calling doAutocompletePageOI40DBPartner.');
        }
        ...
        return this.httpClient.post<PageOI40DBPartner>(`${this.basePath}/integration/OI40DBPartner/doAutocomplete`,
            autoCompleteData,
            {
                withCredentials: this.configuration.withCredentials,
                headers: headers,
     ...
     * @param reportProgress flag to report request and response progress.
     */
    public doLookupPageOI40DBPartner(lookup: LookupData, observe?: 'body', reportProgress?: boolean): Observable<PageOI40DBPartner>;
    public doLookupPageOI40DBPartner(lookup: LookupData, observe?: 'response', reportProgress?: boolean): Observable<HttpResponse<PageOI40DBPartner>>;
    public doLookupPageOI40DBPartner(lookup: LookupData, observe?: 'events', reportProgress?: boolean): Observable<HttpEvent<PageOI40DBPartner>>;
    public doLookupPageOI40DBPartner(lookup: LookupData, observe: any = 'body', reportProgress: boolean = false ): Observable<any> {

        if (lookup === null || lookup === undefined) {
            throw new Error('Required parameter lookup was null or undefined when calling doLookupPageOI40DBPartner.');
        }
        ...
        return this.httpClient.post<PageOI40DBPartner>(`${this.basePath}/integration/OI40DBPartner/doLookup`,
            lookup,
            {
                withCredentials: this.configuration.withCredentials,
                headers: headers,
    ...
    public findByCodeOI40DBPartner(code: string, observe: any = 'body', reportProgress: boolean = false ): Observable<any> {
        ...
        return this.httpClient.get<OI40DBPartner>(`${this.basePath}/integration/OI40DBPartner/byCode`,
            {
                params: queryParameters,
                withCredentials: this.configuration.withCredentials,
                headers: headers,
