...
export class Oi40DbTaskRelationRepositoryService {
     ...
     * @param reportProgress flag to report request and response progress.
     */
    public findAllPage30(p: Pageable, observe?: 'body', reportProgress?: boolean): Observable<PageOI40DBTaskRelation>;
    public findAllPage30(p: Pageable, observe?: 'response', reportProgress?: boolean): Observable<HttpResponse<PageOI40DBTaskRelation>>;
    public findAllPage30(p: Pageable, observe?: 'events', reportProgress?: boolean): Observable<HttpEvent<PageOI40DBTaskRelation>>;
    public findAllPage30(p: Pageable, observe: any = 'body', reportProgress: boolean = false ): Observable<any> {

        if (p === null || p === undefined) {
            throw new Error('Required parameter p was null or undefined when calling findAllPage30.');
        }
     ...
     * @param reportProgress flag to report request and response progress.
     */
    public findByQbePagedPage30(qbe: OI40DBTaskRelation, offset?: number, pageNumber?: number, pageSize?: number, paged?: boolean, sortSorted?: boolean, sortUnsorted?: boolean, unpaged?: boolean, observe?: 'body', reportProgress?: boolean): Observable<PageOI40DBTaskRelation>;
    public findByQbePagedPage30(qbe: OI40DBTaskRelation, offset?: number, pageNumber?: number, pageSize?: number, paged?: boolean, sortSorted?: boolean, sortUnsorted?: boolean, unpaged?: boolean, observe?: 'response', reportProgress?: boolean): Observable<HttpResponse<PageOI40DBTaskRelation>>;
    public findByQbePagedPage30(qbe: OI40DBTaskRelation, offset?: number, pageNumber?: number, pageSize?: number, paged?: boolean, sortSorted?: boolean, sortUnsorted?: boolean, unpaged?: boolean, observe?: 'events', reportProgress?: boolean): Observable<HttpEvent<PageOI40DBTaskRelation>>;
    public findByQbePagedPage30(qbe: OI40DBTaskRelation, offset?: number, pageNumber?: number, pageSize?: number, paged?: boolean, sortSorted?: boolean, sortUnsorted?: boolean, unpaged?: boolean, observe: any = 'body', reportProgress: boolean = false ): Observable<any> {

        if (qbe === null || qbe === undefined) {
            throw new Error('Required parameter qbe was null or undefined when calling findByQbePagedPage30.');
        }
