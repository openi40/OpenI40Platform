...
export class Oi40DbTaskRelationRepositoryService {
    ...
    public deleteByCodeVoid30(code: string, observe: any = 'body', reportProgress: boolean = false ): Observable<any> {
        ...
        return this.httpClient.get<any>(`${this.basePath}/integration/OI40DBTaskRelation/deleteByCode`,
            {
     ...
     * @param reportProgress flag to report request and response progress.
     */
    public doAutocompletePageOI40DBTaskRelation(autoCompleteData: AutoCompleteData, observe?: 'body', reportProgress?: boolean): Observable<PageOI40DBTaskRelation>;
    public doAutocompletePageOI40DBTaskRelation(autoCompleteData: AutoCompleteData, observe?: 'response', reportProgress?: boolean): Observable<HttpResponse<PageOI40DBTaskRelation>>;
    public doAutocompletePageOI40DBTaskRelation(autoCompleteData: AutoCompleteData, observe?: 'events', reportProgress?: boolean): Observable<HttpEvent<PageOI40DBTaskRelation>>;
    public doAutocompletePageOI40DBTaskRelation(autoCompleteData: AutoCompleteData, observe: any = 'body', reportProgress: boolean = false ): Observable<any> {

        if (autoCompleteData === null || autoCompleteData === undefined) {
            throw new Error('Required parameter autoCompleteData was null or undefined when calling doAutocompletePageOI40DBTaskRelation.');
        }
        ...
        return this.httpClient.post<PageOI40DBTaskRelation>(`${this.basePath}/integration/OI40DBTaskRelation/doAutocomplete`,
            autoCompleteData,
            {
                withCredentials: this.configuration.withCredentials,
                headers: headers,
     ...
     * @param reportProgress flag to report request and response progress.
     */
    public doLookupPageOI40DBTaskRelation(lookup: LookupData, observe?: 'body', reportProgress?: boolean): Observable<PageOI40DBTaskRelation>;
    public doLookupPageOI40DBTaskRelation(lookup: LookupData, observe?: 'response', reportProgress?: boolean): Observable<HttpResponse<PageOI40DBTaskRelation>>;
    public doLookupPageOI40DBTaskRelation(lookup: LookupData, observe?: 'events', reportProgress?: boolean): Observable<HttpEvent<PageOI40DBTaskRelation>>;
    public doLookupPageOI40DBTaskRelation(lookup: LookupData, observe: any = 'body', reportProgress: boolean = false ): Observable<any> {

        if (lookup === null || lookup === undefined) {
            throw new Error('Required parameter lookup was null or undefined when calling doLookupPageOI40DBTaskRelation.');
        }
        ...
        return this.httpClient.post<PageOI40DBTaskRelation>(`${this.basePath}/integration/OI40DBTaskRelation/doLookup`,
            lookup,
            {
                withCredentials: this.configuration.withCredentials,
                headers: headers,
    ...
    public findByCodeOI40DBTaskRelation(code: string, observe: any = 'body', reportProgress: boolean = false ): Observable<any> {
        ...
        return this.httpClient.get<OI40DBTaskRelation>(`${this.basePath}/integration/OI40DBTaskRelation/byCode`,
            {
                params: queryParameters,
                withCredentials: this.configuration.withCredentials,
                headers: headers,
