...
export class Oi40DbPurchaseOrderRepositoryService {
     ...
     * @param reportProgress flag to report request and response progress.
     */
    public findAllPage20(p: Pageable, observe?: 'body', reportProgress?: boolean): Observable<PageOI40DBPurchaseOrder>;
    public findAllPage20(p: Pageable, observe?: 'response', reportProgress?: boolean): Observable<HttpResponse<PageOI40DBPurchaseOrder>>;
    public findAllPage20(p: Pageable, observe?: 'events', reportProgress?: boolean): Observable<HttpEvent<PageOI40DBPurchaseOrder>>;
    public findAllPage20(p: Pageable, observe: any = 'body', reportProgress: boolean = false ): Observable<any> {

        if (p === null || p === undefined) {
            throw new Error('Required parameter p was null or undefined when calling findAllPage20.');
        }
     ...
     * @param reportProgress flag to report request and response progress.
     */
    public findByQbePagedPage20(qbe: OI40DBPurchaseOrder, offset?: number, pageNumber?: number, pageSize?: number, paged?: boolean, sortSorted?: boolean, sortUnsorted?: boolean, unpaged?: boolean, observe?: 'body', reportProgress?: boolean): Observable<PageOI40DBPurchaseOrder>;
    public findByQbePagedPage20(qbe: OI40DBPurchaseOrder, offset?: number, pageNumber?: number, pageSize?: number, paged?: boolean, sortSorted?: boolean, sortUnsorted?: boolean, unpaged?: boolean, observe?: 'response', reportProgress?: boolean): Observable<HttpResponse<PageOI40DBPurchaseOrder>>;
    public findByQbePagedPage20(qbe: OI40DBPurchaseOrder, offset?: number, pageNumber?: number, pageSize?: number, paged?: boolean, sortSorted?: boolean, sortUnsorted?: boolean, unpaged?: boolean, observe?: 'events', reportProgress?: boolean): Observable<HttpEvent<PageOI40DBPurchaseOrder>>;
    public findByQbePagedPage20(qbe: OI40DBPurchaseOrder, offset?: number, pageNumber?: number, pageSize?: number, paged?: boolean, sortSorted?: boolean, sortUnsorted?: boolean, unpaged?: boolean, observe: any = 'body', reportProgress: boolean = false ): Observable<any> {

        if (qbe === null || qbe === undefined) {
            throw new Error('Required parameter qbe was null or undefined when calling findByQbePagedPage20.');
        }
