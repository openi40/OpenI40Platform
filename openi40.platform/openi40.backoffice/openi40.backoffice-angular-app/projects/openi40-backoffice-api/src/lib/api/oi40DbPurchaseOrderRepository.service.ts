...
export class Oi40DbPurchaseOrderRepositoryService {
    ...
    public deleteByCodeVoid20(code: string, observe: any = 'body', reportProgress: boolean = false ): Observable<any> {
        ...
        return this.httpClient.get<any>(`${this.basePath}/integration/OI40DBPurchaseOrder/deleteByCode`,
            {
     ...
     * @param reportProgress flag to report request and response progress.
     */
    public doAutocompletePageOI40DBPurchaseOrder(autoCompleteData: AutoCompleteData, observe?: 'body', reportProgress?: boolean): Observable<PageOI40DBPurchaseOrder>;
    public doAutocompletePageOI40DBPurchaseOrder(autoCompleteData: AutoCompleteData, observe?: 'response', reportProgress?: boolean): Observable<HttpResponse<PageOI40DBPurchaseOrder>>;
    public doAutocompletePageOI40DBPurchaseOrder(autoCompleteData: AutoCompleteData, observe?: 'events', reportProgress?: boolean): Observable<HttpEvent<PageOI40DBPurchaseOrder>>;
    public doAutocompletePageOI40DBPurchaseOrder(autoCompleteData: AutoCompleteData, observe: any = 'body', reportProgress: boolean = false ): Observable<any> {

        if (autoCompleteData === null || autoCompleteData === undefined) {
            throw new Error('Required parameter autoCompleteData was null or undefined when calling doAutocompletePageOI40DBPurchaseOrder.');
        }
        ...
        return this.httpClient.post<PageOI40DBPurchaseOrder>(`${this.basePath}/integration/OI40DBPurchaseOrder/doAutocomplete`,
            autoCompleteData,
            {
                withCredentials: this.configuration.withCredentials,
                headers: headers,
    ...
    public findByCodeOI40DBPurchaseOrder(code: string, observe: any = 'body', reportProgress: boolean = false ): Observable<any> {
        ...
        return this.httpClient.get<OI40DBPurchaseOrder>(`${this.basePath}/integration/OI40DBPurchaseOrder/byCode`,
            {
                params: queryParameters,
                withCredentials: this.configuration.withCredentials,
                headers: headers,
