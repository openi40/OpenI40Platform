...
import { WorkCenterRenderer } from './WorkCenterRenderer';
export class DepartmentRenderer extends TreeNodeRenderer<DepartmentDto, DepartmentGuiItem, WorkCenterDto, WorkCenterGuiItem, WorkCenterRenderer> {
}
