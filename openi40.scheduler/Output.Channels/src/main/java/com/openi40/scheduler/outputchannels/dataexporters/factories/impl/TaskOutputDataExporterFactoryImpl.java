 ...
 */
@Service
public class TaskOutputDataExporterFactoryImpl extends AbstractDataExporterFactory<Task, TaskOutputDto, ITaskDao>
		implements ITaskOutputDataExporterFactory {
	@Autowired
	public TaskOutputDataExporterFactoryImpl(ITaskDao dao, IMapperFactory mapperFactory) {
		super(Task.class, TaskOutputDto.class, dao, mapperFactory);
