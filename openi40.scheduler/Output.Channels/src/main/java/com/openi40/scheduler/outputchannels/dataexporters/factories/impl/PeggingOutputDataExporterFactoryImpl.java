 ...
 */
@Service
public class PeggingOutputDataExporterFactoryImpl
		extends AbstractDataExporterFactory<Pegging, PeggingOutputDto, IPeggingDao>
		implements IPeggingOutputDataExporterFactory {
	@Autowired
	public PeggingOutputDataExporterFactoryImpl(IPeggingDao dao, IMapperFactory mapperFactory) {
		super(Pegging.class, PeggingOutputDto.class, dao, mapperFactory);
