 ...
 *
 */
@BusinessInterface(entityClass = AbstractBaseMessage.class)
public interface IApsMessagesHandler extends IBaseMessagesHandler<AbstractBaseMessage> ,IBusinessLogic<AbstractBaseMessage> {
