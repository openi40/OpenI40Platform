...
@AttributeOverride(name = "consumerWorkOrderCode", column = @Column(name = "consmr_work_order_code")),
...
@AttributeOverride(name = "producerWorkOrderCode", column = @Column(name = "prdcr_work_order_code"))
})
