 ...
 *
 */
public interface ITaskPurchaseMaterialReservationImporterFactory extends IDataImporterFactory<TaskPurchaseMaterialReservationInputDto, SupplyReservation>{
