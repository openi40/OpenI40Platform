 ...
 */
@Service
public class TaskImporterFactoryImpl extends AbstractDataImporterFactory<TaskInputDto, Task> implements ITaskImporterFactory{
	@Autowired
	public TaskImporterFactoryImpl(IMapperFactory mapperFactory, ITaskDao apsDataModelDao) {
		super(TaskInputDto.class, Task.class, mapperFactory, apsDataModelDao);
