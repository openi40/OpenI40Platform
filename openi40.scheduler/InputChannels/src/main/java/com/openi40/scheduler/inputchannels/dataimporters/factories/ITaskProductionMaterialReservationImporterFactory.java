 ...
 *
 */
public interface ITaskProductionMaterialReservationImporterFactory extends IDataImporterFactory<TaskProductionMaterialReservationInputDto, SupplyReservation>{
