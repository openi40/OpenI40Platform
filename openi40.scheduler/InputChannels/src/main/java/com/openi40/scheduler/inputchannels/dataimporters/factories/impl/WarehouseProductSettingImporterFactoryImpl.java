...
import com.openi40.scheduler.inputchannels.dataimporters.factories.IWarehouseProductSettingImporterFactory;
 ...
 */
@Service
public class WarehouseProductSettingImporterFactoryImpl extends
		com.openi40.scheduler.inputchannels.dataimporters.AbstractDataImporterFactory<WarehouseProductSettingInputDto, WarehouseProductSetting>
		implements IWarehouseProductSettingImporterFactory {
	@Autowired
	public WarehouseProductSettingImporterFactoryImpl(IMapperFactory mapperFactory,
			IWarehouseProductSettingDao apsDataModelDao) {
		super(WarehouseProductSettingInputDto.class, WarehouseProductSetting.class, mapperFactory, apsDataModelDao);
