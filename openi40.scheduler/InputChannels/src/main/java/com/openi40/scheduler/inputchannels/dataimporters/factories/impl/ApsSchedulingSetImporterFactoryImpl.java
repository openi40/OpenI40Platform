...
import com.openi40.scheduler.inputchannels.dataimporters.factories.IApsSchedulingSetModelImporterFactory;
 ...
 */
@Service
public class ApsSchedulingSetImporterFactoryImpl
		extends AbstractDataImporterFactory<ApsSchedulingSetInputDto, ApsSchedulingSet>
		implements IApsSchedulingSetModelImporterFactory {
	@Autowired
	public ApsSchedulingSetImporterFactoryImpl(IMapperFactory mapperFactory, IApsSchedulingSetDao apsDataModelDao) {
		super(ApsSchedulingSetInputDto.class, ApsSchedulingSet.class, mapperFactory, apsDataModelDao);
