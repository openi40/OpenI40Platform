insert into aps_window (code,description,modified_ts,start_dt,end_dt) values ('APS_WINDOW','Aps window',CURRENT_TIMESTAMP,'2020-12-01 00:00:00','2021-06-01 23:59:59');
insert into tsheet_meta (code,description,modified_ts) values ('DEFAULT','Default working tsheet',CURRENT_TIMESTAMP);
insert into tsheet_meta_working_time_rule (code,tsheet_meta_code,description,modified_ts,day_of_week,start_time,end_time) values ('LUNEDI-MATTINA','DEFAULT','lunedi mattina',CURRENT_TIMESTAMP,2,'08:00:00','13:00:00');
insert into tsheet_meta_working_time_rule (code,tsheet_meta_code,description,modified_ts,day_of_week,start_time,end_time) values ('LUNEDI-POMERIGGIO','DEFAULT','lunedi pomeriggio',CURRENT_TIMESTAMP,2,'13:00:00','19:00:00');

insert into tsheet_meta_working_time_rule (code,tsheet_meta_code,description,modified_ts,day_of_week,start_time,end_time) values ('MARTEDI-MATTINA','DEFAULT','martedi mattina',CURRENT_TIMESTAMP,3,'08:00:00','13:00:00');
insert into tsheet_meta_working_time_rule (code,tsheet_meta_code,description,modified_ts,day_of_week,start_time,end_time) values ('MARTEDI-POMERIGGIO','DEFAULT','martedi pomeriggio',CURRENT_TIMESTAMP,3,'13:00:00','19:00:00');

insert into tsheet_meta_working_time_rule (code,tsheet_meta_code,description,modified_ts,day_of_week,start_time,end_time) values ('MERCOLEDI-MATTINA','DEFAULT','mercoledi mattina',CURRENT_TIMESTAMP,4,'08:00:00','13:00:00');
insert into tsheet_meta_working_time_rule (code,tsheet_meta_code,description,modified_ts,day_of_week,start_time,end_time) values ('MERCOLEDI-POMERIGGIO','DEFAULT','mercoledi pomeriggio',CURRENT_TIMESTAMP,4,'13:00:00','19:00:00');

insert into tsheet_meta_working_time_rule (code,tsheet_meta_code,description,modified_ts,day_of_week,start_time,end_time) values ('GIOVEDI-MATTINA','DEFAULT','giovedi mattina',CURRENT_TIMESTAMP,5,'08:00:00','13:00:00');
insert into tsheet_meta_working_time_rule (code,tsheet_meta_code,description,modified_ts,day_of_week,start_time,end_time) values ('GIOVEDI-POMERIGGIO','DEFAULT','giovedi pomeriggio',CURRENT_TIMESTAMP,5,'13:00:00','19:00:00');

insert into tsheet_meta_working_time_rule (code,tsheet_meta_code,description,modified_ts,day_of_week,start_time,end_time) values ('VENERDI-MATTINA','DEFAULT','venerdi mattina',CURRENT_TIMESTAMP,6,'08:00:00','13:00:00');
insert into tsheet_meta_working_time_rule (code,tsheet_meta_code,description,modified_ts,day_of_week,start_time,end_time) values ('VENERDI-POMERIGGIO','DEFAULT','venerdi pomeriggio',CURRENT_TIMESTAMP,6,'13:00:00','19:00:00');

insert into tsheet_meta_exc_rule (code,tsheet_meta_code,description,modified_ts,working,start_period,end_period) values ('IMMACOLATA','DEFAULT','8 dicembre',CURRENT_TIMESTAMP,false,'2020-12-08 00:00:00','2020-12-09 00:00:00');
insert into tsheet_meta_exc_rule (code,tsheet_meta_code,description,modified_ts,working,start_period,end_period) values ('NATALE','DEFAULT','natale dicembre',CURRENT_TIMESTAMP,false,'2020-12-24 00:00:00','2020-12-26 00:00:00');
insert into tsheet_meta_exc_rule (code,tsheet_meta_code,description,modified_ts,working,start_period,end_period) values ('PRIMA_SETTIMANA_ANNO','DEFAULT','prima settimana annuale',CURRENT_TIMESTAMP,false,'2020-12-31 00:00:00','2021-01-07 00:00:00');
-- productive companies
insert into prdive_company (code,description,modified_ts,removed) values ('ACOMPANY002','Florida keys sport stainless steel company',CURRENT_TIMESTAMP,false);

-- plant
insert into plant (code,description,prdive_company_code,tsheet_meta_code,modified_ts,removed) values ('STB002','Sugarlof Stainless steel Plant','ACOMPANY002','DEFAULT',CURRENT_TIMESTAMP,false);

-- departments
insert into dept (code,description,plant_code,modified_ts,removed) values ('PRD002','Production department','STB002',CURRENT_TIMESTAMP,false);
...
--warehouse 
insert into whouse  (code,description,removed,infinite_capacity,modified_ts,plant_code,tsheet_meta_code) values ('WH002','Warehouse 00A',false,false,CURRENT_TIMESTAMP,'STB002','DEFAULT');
-- changeover matrix
