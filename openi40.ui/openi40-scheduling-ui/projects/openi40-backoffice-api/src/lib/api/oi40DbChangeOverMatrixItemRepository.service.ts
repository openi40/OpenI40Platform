...
export class Oi40DbChangeOverMatrixItemRepositoryService {
    ...
    public deleteByCodeVoid3(code: string, observe: any = 'body', reportProgress: boolean = false ): Observable<any> {
        ...
        return this.httpClient.get<any>(`${this.basePath}/integration/OI40DBChangeOverMatrixItem/deleteByCode`,
            {
     ...
     * @param reportProgress flag to report request and response progress.
     */
    public doAutocompletePageOI40DBChangeOverMatrixItem(autoCompleteData: AutoCompleteData, observe?: 'body', reportProgress?: boolean): Observable<PageOI40DBChangeOverMatrixItem>;
    public doAutocompletePageOI40DBChangeOverMatrixItem(autoCompleteData: AutoCompleteData, observe?: 'response', reportProgress?: boolean): Observable<HttpResponse<PageOI40DBChangeOverMatrixItem>>;
    public doAutocompletePageOI40DBChangeOverMatrixItem(autoCompleteData: AutoCompleteData, observe?: 'events', reportProgress?: boolean): Observable<HttpEvent<PageOI40DBChangeOverMatrixItem>>;
    public doAutocompletePageOI40DBChangeOverMatrixItem(autoCompleteData: AutoCompleteData, observe: any = 'body', reportProgress: boolean = false ): Observable<any> {

        if (autoCompleteData === null || autoCompleteData === undefined) {
            throw new Error('Required parameter autoCompleteData was null or undefined when calling doAutocompletePageOI40DBChangeOverMatrixItem.');
        }
        ...
        return this.httpClient.post<PageOI40DBChangeOverMatrixItem>(`${this.basePath}/integration/OI40DBChangeOverMatrixItem/doAutocomplete`,
            autoCompleteData,
            {
                withCredentials: this.configuration.withCredentials,
                headers: headers,
    ...
    public findByCodeOI40DBChangeOverMatrixItem(code: string, observe: any = 'body', reportProgress: boolean = false ): Observable<any> {
        ...
        return this.httpClient.get<OI40DBChangeOverMatrixItem>(`${this.basePath}/integration/OI40DBChangeOverMatrixItem/byCode`,
            {
                params: queryParameters,
                withCredentials: this.configuration.withCredentials,
                headers: headers,
