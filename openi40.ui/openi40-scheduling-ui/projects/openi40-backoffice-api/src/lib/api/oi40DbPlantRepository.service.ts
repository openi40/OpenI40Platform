...
export class Oi40DbPlantRepositoryService {
    ...
    public deleteByCodeVoid15(code: string, observe: any = 'body', reportProgress: boolean = false ): Observable<any> {
        ...
        return this.httpClient.get<any>(`${this.basePath}/integration/OI40DBPlant/deleteByCode`,
            {
     ...
     * @param reportProgress flag to report request and response progress.
     */
    public doAutocompletePageOI40DBPlant(autoCompleteData: AutoCompleteData, observe?: 'body', reportProgress?: boolean): Observable<PageOI40DBPlant>;
    public doAutocompletePageOI40DBPlant(autoCompleteData: AutoCompleteData, observe?: 'response', reportProgress?: boolean): Observable<HttpResponse<PageOI40DBPlant>>;
    public doAutocompletePageOI40DBPlant(autoCompleteData: AutoCompleteData, observe?: 'events', reportProgress?: boolean): Observable<HttpEvent<PageOI40DBPlant>>;
    public doAutocompletePageOI40DBPlant(autoCompleteData: AutoCompleteData, observe: any = 'body', reportProgress: boolean = false ): Observable<any> {

        if (autoCompleteData === null || autoCompleteData === undefined) {
            throw new Error('Required parameter autoCompleteData was null or undefined when calling doAutocompletePageOI40DBPlant.');
        }
        ...
        return this.httpClient.post<PageOI40DBPlant>(`${this.basePath}/integration/OI40DBPlant/doAutocomplete`,
            autoCompleteData,
            {
                withCredentials: this.configuration.withCredentials,
                headers: headers,
     ...
     * @param reportProgress flag to report request and response progress.
     */
    public doLookupPageOI40DBPlant(lookup: LookupData, observe?: 'body', reportProgress?: boolean): Observable<PageOI40DBPlant>;
    public doLookupPageOI40DBPlant(lookup: LookupData, observe?: 'response', reportProgress?: boolean): Observable<HttpResponse<PageOI40DBPlant>>;
    public doLookupPageOI40DBPlant(lookup: LookupData, observe?: 'events', reportProgress?: boolean): Observable<HttpEvent<PageOI40DBPlant>>;
    public doLookupPageOI40DBPlant(lookup: LookupData, observe: any = 'body', reportProgress: boolean = false ): Observable<any> {

        if (lookup === null || lookup === undefined) {
            throw new Error('Required parameter lookup was null or undefined when calling doLookupPageOI40DBPlant.');
        }
        ...
        return this.httpClient.post<PageOI40DBPlant>(`${this.basePath}/integration/OI40DBPlant/doLookup`,
            lookup,
            {
                withCredentials: this.configuration.withCredentials,
                headers: headers,
    ...
    public findByCodeOI40DBPlant(code: string, observe: any = 'body', reportProgress: boolean = false ): Observable<any> {
        ...
        return this.httpClient.get<OI40DBPlant>(`${this.basePath}/integration/OI40DBPlant/byCode`,
            {
                params: queryParameters,
                withCredentials: this.configuration.withCredentials,
                headers: headers,
