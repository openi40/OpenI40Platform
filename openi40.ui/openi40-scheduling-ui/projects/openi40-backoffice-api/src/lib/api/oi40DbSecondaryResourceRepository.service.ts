...
export class Oi40DbSecondaryResourceRepositoryService {
    ...
    public deleteByCodeVoid25(code: string, observe: any = 'body', reportProgress: boolean = false ): Observable<any> {
        ...
        return this.httpClient.get<any>(`${this.basePath}/integration/OI40DBSecondaryResource/deleteByCode`,
            {
     ...
     * @param reportProgress flag to report request and response progress.
     */
    public doAutocompletePageOI40DBSecondaryResource(autoCompleteData: AutoCompleteData, observe?: 'body', reportProgress?: boolean): Observable<PageOI40DBSecondaryResource>;
    public doAutocompletePageOI40DBSecondaryResource(autoCompleteData: AutoCompleteData, observe?: 'response', reportProgress?: boolean): Observable<HttpResponse<PageOI40DBSecondaryResource>>;
    public doAutocompletePageOI40DBSecondaryResource(autoCompleteData: AutoCompleteData, observe?: 'events', reportProgress?: boolean): Observable<HttpEvent<PageOI40DBSecondaryResource>>;
    public doAutocompletePageOI40DBSecondaryResource(autoCompleteData: AutoCompleteData, observe: any = 'body', reportProgress: boolean = false ): Observable<any> {

        if (autoCompleteData === null || autoCompleteData === undefined) {
            throw new Error('Required parameter autoCompleteData was null or undefined when calling doAutocompletePageOI40DBSecondaryResource.');
        }
        ...
        return this.httpClient.post<PageOI40DBSecondaryResource>(`${this.basePath}/integration/OI40DBSecondaryResource/doAutocomplete`,
            autoCompleteData,
            {
                withCredentials: this.configuration.withCredentials,
                headers: headers,
    ...
    public findByCodeOI40DBSecondaryResource(code: string, observe: any = 'body', reportProgress: boolean = false ): Observable<any> {
        ...
        return this.httpClient.get<OI40DBSecondaryResource>(`${this.basePath}/integration/OI40DBSecondaryResource/byCode`,
            {
                params: queryParameters,
                withCredentials: this.configuration.withCredentials,
                headers: headers,
